...
import { ChevronRight, Clock, Loader2, MessageSquare, Search, Users, AlertCircle, ArrowLeft } from 'lucide-react';
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2">
                          ...
                          {hasCache && (
                            <div className="w-2 h-2 bg-green-500 rounded-full flex-shrink-0" title="已缓存" />
                          )}
                        </div>

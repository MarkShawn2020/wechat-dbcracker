...
import {databasesAtom, keysFilePathAtom} from '../store/atoms';
import {Database, Download, FileText, Table, X} from 'lucide-react';
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-blue-700">
                                Use the "Browse Files" button to select your <code
                                className="bg-blue-100 px-1 rounded">.keys</code> file,

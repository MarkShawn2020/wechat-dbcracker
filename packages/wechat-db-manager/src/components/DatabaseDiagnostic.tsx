...
import {AlertCircle, CheckCircle, Copy, Database, Search, Table} from 'lucide-react';
                        ...
                        {result.contactTable && (
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <div className="space-y-3 text-sm">
                                    <div>
                                        <span
                                            className="font-medium">总联系人数:</span> {result.contactTable.analysis.totalContacts}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1 bg-white rounded border p-2 max-h-32 overflow-y-auto">
                                            {result.contactTable.analysis.sampleIds.slice(0, 10).map((id, idx) => (
                                                <div key={idx}
                                                     className="font-mono text-xs py-1 border-b border-gray-100 last:border-b-0 flex items-center justify-between">
                                                    <span>{id}</span>
                                                    <button
                        ...
                        {result.messageTables.map((messageTable) => (
                            <div key={messageTable.name} className="bg-green-50 border border-green-200 rounded-lg p-4">
                                ...
                                <div className="space-y-3 text-sm">
                                    <div>
                                        <span
                                            className="font-medium">总消息数:</span> {messageTable.analysis.totalMessages}
                                    </div>
